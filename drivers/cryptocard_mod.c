...
#define KEY_A_ADDR 0x0a
#define KEY_B_ADDR 0x0b
		 ...
		 unsigned long ioctl_param)
{
	...
	switch (ioctl_num) {
        case IOCTL_SET_KEY:
            ...
            k_buff = (struct address*)vmalloc(sizeof(struct key_struct)) ;
            ...
            *(drv_priv->hwmem + KEY_A_ADDR) = a;
            *(drv_priv->hwmem + KEY_B_ADDR) = b;
